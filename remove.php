...
<html>
    ...
    <body>
        ...
        <form role="form" method="post" action="<?php echo site_url('user/deletecontact');?>" style="width: 20%; margin: 0 auto; padding-top: 100px;">
                          <fieldset>
                              ...
                              <div>                                                   
                              <input style="color:#FFFFFF;" class="btn" type="submit" value="REMOVE" name="login" >
                              </div>
                              <br>
                              <div>
